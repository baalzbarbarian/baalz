...
import com.advancedandroid.assignment_advanced_android.NewsFeed.NewsFeedAdapter.FeedsAdapter;
...
public class ReadRss extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "https://vietnamnet.vn/rss/giao-duc.rss";
            ...
            for (int i = 0; i < items.getLength(); i++) {
                ...
                if (cureentchild.getNodeName().equalsIgnoreCase("item")) {
                    ...
                    for (int j = 0; j < itemchilds.getLength(); j++) {
                        ...
                        } else if (cureent.getNodeName().startsWith("media:content")) {
